...
public class ModuloSecretaria {
    ...
    public ModuloSecretaria() { int option = -1;
        ...
        while (option != 0) {
            ...
            System.out.println("9 - Visualizar Disciplinas");
            System.out.println("10 - Cadastrar Curso");
            System.out.println("11 - Atualizar Curso");
            System.out.println("12 - Visualizar Cursos");
            System.out.println("13 - Gerar Currículo");
            System.out.println("14 - Visualizar Currículos");
            System.out.println("15 - Visualizar Turmas de um Currículo");
            System.out.println("16 - Abrir Turma");
            ...
            switch (option) {
                ...
                case 14:
                    ...
                    break;
                case 15:
                    visualizarTurmasDeUmCurriculo();
                    break;

                // Opção de Abrir Turma
                case 16:
                    abrirTurma();
                    break;
                ...
                // Sair
                case 0:
                    System.out.println("Saindo do Módulo Secretaria...");
                    break;
